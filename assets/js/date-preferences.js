...
const DatePreferences = {
  ...
  formats: {
    full: {
      label: "Full (January 15, 2024, 3:45 PM)",
      example: "January 15, 2024, 3:45 PM",
    },
    short: {
      label: "Short (Jan 15, 2024, 3:45 PM)",
      example: "Jan 15, 2024, 3:45 PM",
    },
    "numeric-us": {
      label: "Numeric US (01/15/2024 3:45 PM)",
      example: "01/15/2024 3:45 PM",
    },
    "numeric-intl": {
      label: "Numeric Intl (15/01/2024 15:45)",
      example: "15/01/2024 15:45",
    },
  ...
  adjustColumnWidths() {
    ...
    document
      .querySelectorAll("th:has([data-date]), td:has([data-date])")
      .forEach((cell) => {
