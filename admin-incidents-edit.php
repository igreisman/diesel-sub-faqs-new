...
<head>
    ...
    <title><?php echo $isEdit ? 'Edit' : 'Add'; ?> Incident - Admin</title>
...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <span class="navbar-brand">Admin: <?php echo $isEdit ? 'Edit' : 'Add'; ?> Incident</span>
            <div>
            ...
            <div class="card-body">
                <form method="POST">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="submarine_name" name="submarine_name" 
                                   value="<?php echo htmlspecialchars($incident['submarine_name'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="hull_number" name="hull_number" 
                                   value="<?php echo htmlspecialchars($incident['hull_number'] ?? ''); ?>" 
                                   placeholder="SS-164">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control" id="date" name="date" 
                                   value="<?php echo htmlspecialchars($incident['date'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="era" class="form-label">Era *</label>
                            <select class="form-select" id="era" name="era" required>
                                <option value="Pre-WW2" <?php echo ($incident['era'] ?? '') === 'Pre-WW2' ? 'selected' : ''; ?>>Pre-WW2</option>
                                <option value="WW2" <?php echo ($incident['era'] ?? '') === 'WW2' ? 'selected' : ''; ?>>WW2</option>
                                <option value="Post-WW2" <?php echo ($incident['era'] ?? '') === 'Post-WW2' ? 'selected' : ''; ?>>Post-WW2</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="casualties" class="form-label">Casualties *</label>
                            <input type="number" class="form-control" id="casualties" name="casualties" 
                                   value="<?php echo htmlspecialchars($incident['casualties'] ?? '0'); ?>" 
                                   min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="incident_type" name="incident_type" 
                                   value="<?php echo htmlspecialchars($incident['incident_type'] ?? ''); ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="status" name="status" 
                                   value="<?php echo htmlspecialchars($incident['status'] ?? ''); ?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" required><?php echo htmlspecialchars($incident['description'] ?? ''); ?></textarea>
                        <div class="form-text">Full description of the incident</div>
                    </div>

                    <div class="mb-3">
                        <label for="notes" class="form-label">Notes</label>
                        <textarea class="form-control" id="notes" name="notes" style="min-height: 100px;"><?php echo htmlspecialchars($incident['notes'] ?? ''); ?></textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> <?php echo $isEdit ? 'Update' : 'Add'; ?> Incident
                        </button>
                    </div>
                </form>
            </div>
