...
try {
    $stmt = $pdo->query("
        SELECT id, boat_number, name, designation, date_lost, location, era, year_lost 
        FROM lost_submarines 
        ORDER BY year_lost ASC, date_lost ASC
    ");
...
<body>
    <div class="container mt-4">
        ...
        <!-- Add Button -->
        <div class="mb-3">
            <a href="admin-eternal-patrol-edit.php" class="btn btn-success btn-lg">
                + Add New Submarine
            </a>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-secondary">
                                                <?= strtoupper(str_replace('-', ' ', $sub['era'])) ?>
                                            </span>
                                        </td>
